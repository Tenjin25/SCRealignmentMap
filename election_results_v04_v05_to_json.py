...
files = [
    ('SC/Data/election_data_SC.v04_with_county.csv', 'sc_election_results_v04_structured.json'),
    ('SC/Data/election_data_SC.v05_with_county.csv', 'sc_election_results_v05_structured.json'),
]

def process_election_file(input_csv, output_json):
    ...
    metadata = {
        'title': f'South Carolina Election Results Structured ({input_csv})',
...
for input_csv, output_json in files:
    process_election_file(input_csv, output_json)
